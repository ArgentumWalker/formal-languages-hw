...
public class VariableValueAssignStatement extends Statement {
    private final String name;
    private final Expression expression;

    public VariableValueAssignStatement(long line, long col, String name, Expression expression) {
        super(line, col);
        this.name = name;
